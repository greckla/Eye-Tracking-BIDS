...
before running the script
 ...
 - save all raw .asc files into a folder called <TaskName>_raw_data
...
for (file in 1:length(input_file_names)){
  ...
  for (event_nr in 1:length(tmp_file_onset)){
    ...
    event_identifier =   strsplit(tmp_file_onset[event_nr], split="\t")[[1]][4]
    ###### OPTIONAL #####
  ...
  event_df = data.frame(onset,duration,sample,trial,eventIdentifier, blocktrial,
  ...
  event_df = event_df[c("onset", "duration", "sample", "trial_type","eventIdentifier",
                        "event_nr","aoi", "trial", "blocktrial")]
